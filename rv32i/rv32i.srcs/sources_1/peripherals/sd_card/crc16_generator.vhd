...
entity crc16_generator is
   port (
      ...
      crc_result     : out    std_logic_vector(15 downto 0)
   );
end crc16_generator;


architecture Behavioral of crc16_generator is
   constant CRC_LENGTH : integer := 16;
   constant POLYNOMIAL : std_logic_vector(CRC_LENGTH - 1 downto 0) := "0001000000100001";
begin
   gen_crc : process (clk_data, reset_crc)
   begin
      if reset_crc = '1' then
         crc_result <= (others => '0');
